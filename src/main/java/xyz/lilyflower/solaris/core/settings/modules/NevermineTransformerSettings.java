...
public class NevermineTransformerSettings implements TransformerSettingsModule {
    ...
    public static boolean DISABLE_RENDERING = true;
    ...
    public void init() {
        SolarisTransformerSettings.add("aoa", configuration -> {
            ...
            """
                 This, and the five options below, forcibly allow AoA entities to take specific damage types. However, the others leave a lot to be desired due to how the patches work.
            ...
            DISABLE_RENDERING = configuration.getBoolean("disableCreatureIcons", "nevermine.entity", true, "Disables the HUD icon above entities indicating the allowed damage types.");
        });
    }
}
